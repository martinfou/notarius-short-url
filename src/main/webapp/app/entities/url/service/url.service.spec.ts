...
import { UrlService, RestUrl } from './url.service';

const requireRestSample: RestUrl = {
  ...sampleWithRequiredData,
  creationDateTime: sampleWithRequiredData.creationDateTime?.toJSON(),
  expirationDateTime: sampleWithRequiredData.expirationDateTime?.toJSON(),
};
